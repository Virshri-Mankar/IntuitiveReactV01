            ...
            <div className="row mrt15">
                <div className="flexcontact">
                        ...
                        <div>
                            ...
                            <div className="contact-info  mailtxt ">
                                ...
                                <div className="contact-info-text">
                                    ...
                                    <span>
                                    <a href="mailto:info@intuitiveitsolution.com">
                                        <b> info@intuitiveitsolution.com</b>
                                    </a>
                                    </span>
                                </div>
                                </div>
                            ...
                            <div className="column">
                                ...
                                <div className="contact-info-item">
                                    ...
                                    <span>
                                        <a href="tel:+18044065534">
                                        <b>+1&nbsp;804&nbsp;406&nbsp;5534</b>
                                        </a>
                                    </span>
                                    <span>
                                        <a href="tel:+919730200667">
                                        <b> +91 9730200667</b>
                                        </a>
                                    </span>
                                    </div>
                            ...
                            <div className="column">
                                ...
                                <div className="contact-info-item">
                                    ...
                                    <span>
                                        ...
                                        <b>
                                            {" "}
                                            8501 Mayland Drive, <br /> STE 105, Henrico{" "}
                                            <br /> VA 23294{" "}
                                        </b>
                                        </a>{" "}
                                    </span>
                    ...
                    <div className="contact-page-form">
                        ...
                        {status?.type === "error" && (
                        <p>
                            "Wysyłanie wiadomości nie powdioło się. Spróbuj jeszcze
                            raz."
                        </p>
                        )}
